...
yystate(16, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 104 ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
yystate(16, [C|Ics], Line, Tlen, Action, Alen) when C >= 106, C =< 108 ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
yystate(16, [C|Ics], Line, Tlen, Action, Alen) when C >= 110, C =< 122 ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
...
yystate(10, [C|Ics], Line, Tlen, Action, Alen) when C >= 98, C =< 122 ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
...
yystate(8, [58|Ics], Line, Tlen, Action, Alen) ->
    yystate(2, Ics, Line, Tlen+1, Action, Alen);
yystate(8, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 104 ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
yystate(8, [C|Ics], Line, Tlen, Action, Alen) when C >= 106, C =< 122 ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
...
yystate(6, [58|Ics], Line, Tlen, Action, Alen) ->
    yystate(2, Ics, Line, Tlen+1, Action, Alen);
yystate(6, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 109 ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
yystate(6, [C|Ics], Line, Tlen, Action, Alen) when C >= 111, C =< 122 ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
...
yystate(1, [58|Ics], Line, Tlen, Action, Alen) ->
    yystate(2, Ics, Line, Tlen+1, Action, Alen);
yystate(1, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 115 ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
yystate(1, [C|Ics], Line, Tlen, Action, Alen) when C >= 117, C =< 122 ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
...
yystate(0, [58|Ics], Line, Tlen, Action, Alen) ->
    yystate(2, Ics, Line, Tlen+1, Action, Alen);
yystate(0, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 109 ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
yystate(0, [C|Ics], Line, Tlen, Action, Alen) when C >= 111, C =< 122 ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
...
-file("./rules_lexer.xrl", 11).
yyaction_0(TokenChars, TokenLine) ->
     { token, { integer, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_1/2}).
-file("./rules_lexer.xrl", 12).
yyaction_1(TokenChars, TokenLine) ->
     { token, { atom, TokenLine, to_atom (TokenChars) } } .

-compile({inline,yyaction_2/3}).
-file("./rules_lexer.xrl", 13).
yyaction_2(TokenChars, TokenLen, TokenLine) ->
     { token, { key, TokenLine, list_to_atom (lists : sublist (TokenChars, 1, TokenLen - 1)) } } .

-compile({inline,yyaction_3/1}).
-file("./rules_lexer.xrl", 14).
yyaction_3(TokenLine) ->
     { token, { '{', TokenLine } } .

-compile({inline,yyaction_4/1}).
-file("./rules_lexer.xrl", 15).
yyaction_4(TokenLine) ->
     { token, { '}', TokenLine } } .

-compile({inline,yyaction_5/1}).
-file("./rules_lexer.xrl", 16).
yyaction_5(TokenLine) ->
     { token, { main, TokenLine } } .

-compile({inline,yyaction_6/1}).
-file("./rules_lexer.xrl", 17).
yyaction_6(TokenLine) ->
     { token, { int, TokenLine } } .

-compile({inline,yyaction_7/1}).
-file("./rules_lexer.xrl", 18).
yyaction_7(TokenLine) ->
     { token, { '(', TokenLine } } .

-compile({inline,yyaction_8/1}).
-file("./rules_lexer.xrl", 19).
yyaction_8(TokenLine) ->
     { token, { ')', TokenLine } } .

-compile({inline,yyaction_9/0}).
-file("./rules_lexer.xrl", 21).
yyaction_9() ->
     skip_token .
